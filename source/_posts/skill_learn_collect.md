...
tags:
    ...
    - 数据库
categories: 技术栈
thumbnail: https://meto.chinakook.com/1440x900_0744879b901e356.jpg
---

> 收集在学习和提高技术过程中遇到的比较有价值的网站、文档、Blog 等，方便自己查阅。

<!--more-->

由于自己在学习过程中积累了一些博客、文档等学习资料，以前一直在自己电脑本地拉个快捷方式存在本地，以便日后翻阅复习。由于偶然，自己在整理资料过程中，看到有前辈在 GitHub 上做过资料的整理，所以我自己也产生了这个想法。然后就有了这个 GitHub 仓库。希望可以给大家带来方便，并且希望能有帮助到大家的资料，这个仓库以后会一直维护下去，并会经常更新。当然希望大家可以参与进来一起维护，欢迎 pull ，欢迎 pull  request 。同时，希望大家多多 star ，哈哈。

问题：不知道是什么原因，在简书上点击Tag会跳转到新页面，不会跳转到当前页面指定的Tag。不过在我的[个人博客](http://ikookblog.com/2017/02/21/Skill-learn-collect/)和 GitHub 上没有任何问题。给大家带来不便，还请谅解。不会既然是 GitHub 仓库，当然是在 GitHub最好，所以建议大家转步 GitHub。

GitHub 仓库地址：[Skill-learn-collect](https://github.com/china-kook/Skill-learn-collect)
欢迎提 issues，欢迎 Star。

<h2 id='tags'>Tags</h2>

[Android](#android)      [Java](#java)       [Kotlin](#kotlin)       [设计模式](#shejimoshi)        [Android/Android Studio 相关](#android-studio)           [数据库](#sql)             [Git](#git)          [GitHub](#github)               [Android/View&UI 相关](#view-ui)            [MVP](#mvp)               [开源项目](#kaiyuanxiangmu)           [Linux](#linux)            [效率工具](#xiaolv)                 [框架](#kuangjia)                [Android/Material Design 相关](#material-design)             [技术漫谈](#mantan)                [Appium](#appium)               [其他收集类GitHub地址](#qita)  



<h3 id='android'>Android</h3>[点击此处回到Tags](#tags)
- #### Blogs
...
<h3 id='java'>Java</h3>[点击此处回到Tags](#tags)
- #### Blogs
...
<h3 id='kotlin'>Kotlin</h3>[点击此处回到Tags](#tags)
...
<h3 id='shejimoshi'>设计模式</h3>[点击此处回到Tags](#tags)
...
<h3 id='sql'>数据库</h3>[点击此处回到Tags](#tags)
...
<h3 id='git'>Git</h3>[点击此处回到Tags](#tags)
...
<h3 id='github'>GitHub</h3>[点击此处回到Tags](#tags)
...
<h3 id='mvp'>MVP</h3>[点击此处回到Tags](#tags)
...
<h3 id='kaiyuanxiangmu'>开源项目</h3>[点击此处回到Tags](#tags)
...
<h3 id='linux'>Linux</h3>[点击此处回到Tags](#tags)
  - #### Blogs
...
<h3 id='xiaolv'>效率工具</h3>[点击此处回到Tags](#tags)
...
<h3 id='appium'>Appium</h3>[点击此处回到Tags](#tags)
...
<h3 id='kuangjia'>框架</h3>[点击此处回到Tags](#tags)
...
<h3 id='mantan'>技术漫谈</h3>[点击此处回到Tags](#tags)
...
<h3 id='qita'>其他收集类GitHub地址</h3>[点击此处回到Tags](#tags)
